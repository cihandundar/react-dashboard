  ...
  return (
    <div className="cart">
      <div className="cart__container">
        {cartBox.map((cartItem) => (
          <div className="cart__box" key={cartItem.id}>
            <div className="cart__box__text">
              <p>{cartItem.title}</p>
              <div className="cart__box__rating">
                <h2>{cartItem.price}</h2>
                <span
                  className="rating"
                  style={{ color: cartItem.rating > 1 ? "lime" : "red" }}
                >
                  {cartItem.rating}%
                </span>
              </div>
            </div>
            <div className="cart__box__icon">
