...
const Sidebar = () => {
  ...
  return (
    <div>
        ...
        <div className="aside__container">
          ...
          {user?.user ? (
            <ul className="aside__list">
              ...
              <li className="aside__list__link">
                <NavLink to="/tables" onClick={showNavbar}>
                  <span className="aside__list__link__icon">
                    <svg
                      stroke="currentColor"
                      fill="currentColor"
              ...
              <li className="aside__list__link">
                <NavLink to="/billing" onClick={showNavbar}>
                  <span className="aside__list__link__icon">
                    <svg
                      stroke="currentColor"
                      fill="currentColor"
              ...
              <li className="aside__list__link">
                <NavLink to="/profile" onClick={showNavbar}>
                  <span className="aside__list__link__icon">
                    <svg
                      stroke="currentColor"
                      fill="currentColor"
              ...
              <li>
                <button
                  className="aside__btn aside__closebtn"
                  onClick={showNavbar}
                >
                  <FaTimes />
                </button>
            ...
            <ul className="aside__list">
              <li className="aside__list__link">
                <NavLink to="/signin" onClick={showNavbar}>
                  <span className="aside__list__link__icon">
                    <svg
                      stroke="currentColor"
                      fill="currentColor"
              ...
              <li className="aside__list__link">
                <NavLink to="/signup" onClick={showNavbar}>
                  <span className="aside__list__link__icon">
                    <svg
                      stroke="currentColor"
                      fill="currentColor"
      ...
      <button className="aside__btn" onClick={showNavbar}>
        <FaBars />
      </button>
    </div>
  );
